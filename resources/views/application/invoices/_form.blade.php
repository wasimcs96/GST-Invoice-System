    ...
    <div class="row no-gutters card-form__body card-body bg-white">
        ...
        <div class="col-md-4 pr-4 pl-4">
            <div class="form-group required">
                ...
                <input name="invoice_date" type="date" id="datepicker1" class="form-control input"
                    data-toggle="flatpickr" data-flatpickr-default-date="{{ $invoice->invoice_date ?? now() }}"
                    required>
            </div>
            <div class="form-group required">
                    ...
                    <tbody class="list" id="items">
                        <tr id="product_row_template" class="d-none">
                            <td class="select-container">
                                ...
                                <div class="d-none select-footer">
                                    <a data-toggle="modal" data-target="#addProduct" class="font-weight-300">+
                        ...
                        @if ($invoice->items->count() > 0)
                            @foreach ($invoice->items as $item)
                                <tr>
                                    <td class="select-container">
                                        <select name="product[]" class="form-control priceListener select-with-footer"
                                            required>
        ...
        <div class="col-md-5 mt-5 pr-4">
            <div class="form-group">
                <label for="notes">Message on invoice</label>
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ml-auto h5 mb-0">
                        <input id="grand_total" name="grand_total" type="text"
                            class="price_input price-text w-100 fs-inherit" value="{{ $invoice->total ?? 0 }}"
                            readonly>
                    </div>
                </div>
        ...
        <div class="col-12 text-center float-right mt-3">
            <button type="button"
                class="btn btn-primary save_form_button">{{ __('messages.save_invoice') }}</button>
        </div>
    </div>
</div>
