    ...
    <div class="row no-gutters card-form__body card-body bg-white">
        ...
        <div class="col-md-4 pr-4 pl-4">
            <div class="form-group required">
                ...
                <input name="payment_date" type="date" class="form-control input" data-toggle="flatpickr"
                    data-flatpickr-default-date="{{ $expense->payment_date ?? now() }}"
                    value="{{ $expense->payment_date }}" required>
            </div>
            <div class="form-group required select-container">
                <label for="customer">Payment Method</label>
                <select id="payment_method" name="payment_method" data-toggle="select"
                    class="form-control select2 select2-hidden-accessible select-with-footer" {{-- data-select2-id="customer" --}}>
        ...
        <div class="col-md-4 pl-4">
            <div class="form-group">
                ...
                <div class="input-group input-group-merge">
                    <input name="reference_number" type="text" maxlength="6" class="form-control form-control-prepended"
                        value="{{ $expense->reference_number }}" autocomplete="off">
            ...
            <div class="form-group required select-container">
                ...
                <select id="payment_account_id" name="payment_account_id" data-toggle="select"
                    class="form-control select2 select2-hidden-accessible select-with-footer">
                        ...
                        <tr id="product_row_template" class="d-none">
                            ...
                            <td class="select-container" style="padding-right: 103px;">
                                ...
                                <div class="d-none select-footer">
                                    ...
                                    <a data-toggle="modal" data-target="#categoryModal" class="font-weight-300">+ Add
                                        Category</a>
                                </div>
                            </td>
                            {{-- @if ($tax_per_item) --}}
                            ...
                            {{-- @endif --}}
                            <td>
                                <input hidden name="quantity[]" type="number" class="form-control priceListener"
                                    value="1" required>
                                    ...
                                    <td class="select-container">
                                        <select name="expense_category_id[]"
                                            ...
                                            <option value="{{ $item->expense_category_id }}"
                                                {{ $item->category->name ? 'selected=""' : '' }}>
                                                {{ $item->category->name }}</option>
                                        </select>
                                        <div class="d-none select-footer">
                                            <a data-toggle="modal" data-target="#categoryModal"
                                                class="font-weight-300">+ Add Category</a>
                                        </div>
                                    </td>
                                    <td>
                                        <input hidden name="quantity[]" type="number" class="form-control priceListener"
                                            value="{{ $item->quantity }}" required>
                                        <input name="description[]" type="text" class="form-control priceListener"
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ml-auto h6 mb-0">
                        <input id="sub_total" name="sub_total" type="text"
                            class="price_input price-text w-100 fs-inherit" value="{{ $expense->sub_total ?? 0 }}"
                            readonly>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ml-auto h5 mb-0">
                        <input id="grand_total" name="grand_total" type="text"
                            class="price_input price-text w-100 fs-inherit" value="{{ $expense->total ?? 0 }}"
                            readonly>
                    </div>
                </div>
            </div>
