    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('products.create', ['company_uid' => $currentCompany->uid]) }}" class="btn btn-success ml-3 float-right"><i class="material-icons"></i> {{ __('messages.create_product') }}</a>
            </div>
            @if ($products->count() > 0)
                                  ...
                                  {!! money($product->price, $product->currency_code) !!}
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <!-- <a href="{{ route('products.details', ['customer' => $customer->id,'company_uid' => $currentCompany->uid]) }}" class="btn btn-sm btn-link"><i class="material-icons icon-16pt">arrow_forward</i></a> -->
                                            </div>
                                        </div>
                                    </td>
                                </tr>
