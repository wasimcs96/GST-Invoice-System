    ...
    <div class="col-xl-2 col-md-4 col-sm-6">
        <div class="card text-center">
            <div class="card-body">
                ...
                <a href="{{ route('settings.accounts_setting', ['company_uid' => $currentCompany->uid]) }}" class="card-text" aria-expanded="false">
                    {{-- <span class="card-text">{{ __('messages.expense_categories') }}</span> --}}
                    <p class="card-text">Add Account</p>
                </a>
            </div>
        </div>
    </div>
    <div class="col-xl-2 col-md-4 col-sm-6">
        <div class="card text-center">
            <div class="card-body">
                ...
                <a href="{{ route('settings.account_details', ['company_uid' => $currentCompany->uid]) }}" class="card-text" aria-expanded="false">
                    {{-- <span class="card-text">{{ __('messages.expense_categories') }}</span> --}}
    ...
    <div class="col-xl-2 col-md-4 col-sm-6">
        <div class="card text-center">
            <div class="card-body">
                ...
                <a href="{{ route('settings.product_sac', ['company_uid' => $currentCompany->uid]) }}" class="card-text" aria-expanded="false">
                    {{-- <span class="card-text">{{ __('messages.expense_categories') }}</span> --}}
                    <p class="card-text">Product Sac Code</p>
                </a>
            </div>
        </div>
    </div>
    <div class="col-xl-2 col-md-4 col-sm-6">
        <div class="card text-center">
            <div class="card-body">
                ...
                <a href="{{ route('settings.product_service', ['company_uid' => $currentCompany->uid]) }}" class="card-text" aria-expanded="false">
                    {{-- <span class="card-text">{{ __('messages.expense_categories') }}</span> --}}
                    <p class="card-text">Product Service</p>
                </a>
            </div>
        </div>
    </div>
