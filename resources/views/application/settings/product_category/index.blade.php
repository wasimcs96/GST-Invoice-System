...
@section('content')
    <div class="page__heading">
        ...
        <h1 class="m-1">Product Category</h1>
    </div>
                ...
                <div class="row no-gutters">
                    <div class="col card-form__body card-body bg-white">
                        ...
                        <div class="form-row align-items-center mb-4">
                            <div class="col">
                                <p class="h4 mb-0">
                                    <strong class="headings-color">Product Category</strong>
                                </p>
                            </div>
                            <div class="col-auto">
                                <a href="{{ route('settings.product_categories.create', ['company_uid' => $currentCompany->uid]) }}" class="btn btn-primary text-white">
                                ...
                                <table class="table table-xl mb-0 thead-border-top-0 table-striped">
                                    ...
                                    <tbody class="list" id="expense_categories">
                                        @foreach($product_categories as $product_category)
                                            <tr>
                                                <td class="h6">
                                                    <a href="{{ route('settings.product_categories.edit', ['product_category' => $product_category->id, 'company_uid' => $currentCompany->uid]) }}">
                                                        <strong class="h6">
                        ...
                        @else
                            ...
                            <div class="row justify-content-center card-body pb-5">
                                <p class="h4">No Product Category</p>
                            </div>
                        @endif
