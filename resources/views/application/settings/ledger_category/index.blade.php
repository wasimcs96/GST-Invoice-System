    ...
    <div class="page__heading">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Ledger Category</li>
            </ol>
        </nav>
        <a href="{{ URL(''.auth()->user()->uid.'/settings/index') }}" class="btn btn-info float-right">Back</a>
        <h1 class="m-1">Ledger Category</h1>
    </div>
                ...
                <div class="row no-gutters">
                    <div class="col card-form__body card-body bg-white">
                        ...
                        <div class="form-row align-items-center mb-4">
                            <div class="col">
                                <p class="h4 mb-0">
                                    <strong class="headings-color">Ledger Category</strong>
                                </p>
                            </div>
                            <div class="col-auto">
                                <a href="{{ route('settings.ledger_categories.create', ['company_uid' => $currentCompany->uid]) }}" class="btn btn-primary text-white">
                                    Add Ledger Category
                                </a>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        href="{{ route('settings.ledger_categories.edit', ['ledger_category' => $expense_category->id, 'company_uid' => $currentCompany->uid]) }}">
                                                        <i data-feather="edit-2"></i>
                                                        {{ __('messages.edit') }}
                                                            </a>
                                                            <a class="dropdown-item"
                                                            href="{{ route('settings.ledger_categories.delete', ['ledger_category' => $expense_category->id, 'company_uid' => $currentCompany->uid]) }}">
