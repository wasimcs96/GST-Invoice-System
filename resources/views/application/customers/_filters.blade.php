    ...
    <div class="card card-form d-flex flex-column flex-sm-row">
        <div class="card-form__body card-body-form-group flex">
            <div class="row container-fluid my-2">
                ...
                <input name="filter[first_name]" type="text" class="form-control"
                    value="{{ isset(Request::get("filter")['first_name']) ? Request::get("filter")['first_name'] : '' }}"
        ...
        <div class="col-md-6 col-12">
            <div class="form-group">
                ...
                <input type="text" id="first-name-column" class="form-control"
                    value="{{ isset(Request::get("filter")['first_name']) ? Request::get("filter")['first_name'] : '' }}"
                    placeholder="{{ __('messages.search') }}" name="filter[first_name]" />
            </div>
        </div>
        {{-- <div class="col-sm-auto">
                    <div class="form-group">
                        <label for="filter[email]">{{ __('messages.email') }}</label>
        <input name="filter[email]" type="text" class="form-control"
            value="{{ isset(Request::get("filter")['email']) ? Request::get("filter")['email'] : '' }}"
            placeholder="{{ __('messages.search') }}">
    </div>
    </div> --}}
    <div class="col-md-6 col-12">
        <div class="form-group">
            ...
            <input type="text" id="last-name-column" class="form-control"
                value="{{ isset(Request::get("filter")['email']) ? Request::get("filter")['email'] : '' }}"
                placeholder="{{ __('messages.search') }}" name="filter[email]" />
        </div>
    </div>
    </div>
