    ...
    <div class="row no-gutters card-form__body card-body bg-white">
        ...
        <div class="col-md-4 pr-2">
            ...
            <div class="form-group required select-container">
                ...
                <div class="d-none select-footer">
                    <a data-toggle="modal" data-target="#exampleModal" class="font-weight-300">+
        ...
        <div class="col-md-4 pr-4 pl-4">
            <div class="form-group required">
                ...
                <input name="estimate_date" type="date" class="form-control input" data-toggle="flatpickr"
            ...
            <div class="form-group required">
                ...
                <div class="input-group">
                    ...
                    <input name="estimate_number" type="text" maxlength="6" class="form-control form-control-prepended"
                        ...
                        <tr id="product_row_template" class="d-none">
                            ...
                            <td class="select-container" style="padding-right: 103px;">
                                <select name="product[]" class="form-control priceListener select-with-footer"
                                    style="padding-right: 103px;" required>
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ml-auto h6 mb-0">
                        <input id="sub_total" name="sub_total" type="text"
                            class="price_input price-text w-100 fs-inherit" value="{{ $estimate->sub_total ?? 0 }}"
                            readonly>
                    </div>
                </div>
                    ...
                    {{-- <div class="row mb-1">
                        ...
                        <div class="col-12 h6 mb-0">
                            <div class="form-group select-container">
                                <select id="total_taxes" name="total_taxes[]" data-toggle="select"
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ml-auto h5 mb-0">
                        <input id="grand_total" name="grand_total" type="text"
                            class="price_input price-text w-100 fs-inherit" value="{{ $estimate->total ?? 0 }}"
                            readonly>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 text-center float-right mt-3">
            <button type="button"
                class="btn btn-primary save_form_button">{{ __('messages.save_estimate') }}</button>
        </div>
    </div>
</div>
