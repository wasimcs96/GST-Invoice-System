        ...
        <div class="card-form__body card-body-form-group flex">
            <div class="row container-fluid my-2">
                ...
                <div class="col-md-3 col-12">
                    <div class="form-group">
                        <label for="filter[expense_category_id]">Ledger Category</label>
                ...
                <div class="col-md-3 col-12">
                    <div class="form-group">
                        ...
                        <input name="filter[from]" type="date" class="form-control" data-toggle="flatpickr"
                            data-flatpickr-default-date="{{ isset(Request::get('filter')['from']) ? Request::get('filter')['from'] : '' }}"
                ...
                <div class="col-md-3 col-12">
                    <div class="form-group">
                        ...
                        <input name="filter[to]" type="date" class="form-control" data-toggle="flatpickr"
                            data-flatpickr-default-date="{{ isset(Request::get('filter')['to']) ? Request::get('filter')['to'] : '' }}"
            ...
            <div class="row mb-2">
                <div class="col-12 mx-1">
                    <a
                        href="{{ route('ledgers', ['company_uid' => $currentCompany->uid]) }}">{{ __('messages.clear_filters') }}</a>
                </div>
            </div>
        </div>
