            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input name="google_recapthca_key" type="text" class="form-control" placeholder="{{ __('messages.google_recapthca_key') }}" value="{{ get_system_setting('google_recapthca_key') }}">
                    </div>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ __('messages.application_settings') }}</h4>
                </div>
                <div class="card-body">
                        <div class="row">
