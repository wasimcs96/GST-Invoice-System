                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group required">
                                <label for="paypal_username">{{ __('messages.username') }}</label>
                                <input name="paypal_username" type="text" class="form-control"
                                    placeholder="{{ __('messages.username') }}"
                                    value="{{ get_system_setting('paypal_username') }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group required">
                                <label for="paypal_password">{{ __('messages.password') }}</label>
                                <input name="paypal_password" type="text" class="form-control"
                                    placeholder="{{ __('messages.password') }}"
                                    value="{{ get_system_setting('paypal_password') }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group required">
                                <label for="paypal_signature">{{ __('messages.signature') }}</label>
                                <input name="paypal_signature" type="text" class="form-control"
                                    placeholder="{{ __('messages.enter_signature') }}"
                                    value="{{ get_system_setting('paypal_signature') }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <select name="paypal_test_mode" class="form-control">
                                    <option value="0"
                                        {{ get_system_setting('paypal_test_mode') == false ? 'selected' : '' }}>
                                        {{ __('messages.false') }}</option>
                                    <option value="1"
                                        {{ get_system_setting('paypal_test_mode') == true ? 'selected' : '' }}>
                                        {{ __('messages.true') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <select name="paypal_active" class="form-control">
                                    <option value="0"
                                        {{ get_system_setting('paypal_active') == false ? 'selected' : '' }}>
                                        {{ __('messages.disabled') }}</option>
                                    <option value="1"
                                        {{ get_system_setting('paypal_active') == true ? 'selected' : '' }}>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group required">
                                <label for="stripe_public_key">{{ __('messages.publishable_key') }}</label>
                                <input name="stripe_public_key" type="text" class="form-control"
                                    placeholder="{{ __('messages.publishable_key') }}"
                                    value="{{ get_system_setting('stripe_public_key') }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group required">
                                ...
                                <input name="stripe_secret_key" type="text" class="form-control"
                                    placeholder="{{ __('messages.secret_key') }}"
                                    value="{{ get_system_setting('stripe_secret_key') }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <select name="stripe_test_mode" class="form-control">
                                    <option value="0"
                                        {{ get_system_setting('stripe_test_mode') == false ? 'selected' : '' }}>
                                        {{ __('messages.false') }}</option>
                                    <option value="1"
                                        {{ get_system_setting('stripe_test_mode') == true ? 'selected' : '' }}>
                                        {{ __('messages.true') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <select name="stripe_active" class="form-control">
                                    <option value="0"
                                        {{ get_system_setting('stripe_active') == false ? 'selected' : '' }}>
                                        {{ __('messages.disabled') }}</option>
                                    <option value="1"
                                        {{ get_system_setting('stripe_active') == true ? 'selected' : '' }}>
                                        {{ __('messages.active') }}</option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group required">
                                <label for="razorpay_id">{{ __('messages.razorpay_id') }}</label>
                                <input name="razorpay_id" type="text" class="form-control"
                                    placeholder="{{ __('messages.razorpay_id') }}"
                                    value="{{ get_system_setting('razorpay_id') }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group required">
                                ...
                                <input name="razorpay_secret_key" type="text" class="form-control"
                                    placeholder="{{ __('messages.razorpay_secret_key') }}"
                                    value="{{ get_system_setting('razorpay_secret_key') }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <select name="razorpay_test_mode" class="form-control">
                                    <option value="0"
                                        {{ get_system_setting('razorpay_test_mode') == false ? 'selected' : '' }}>
                                        {{ __('messages.false') }}</option>
                                    <option value="1"
                                        {{ get_system_setting('razorpay_test_mode') == true ? 'selected' : '' }}>
                                        {{ __('messages.true') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <select name="razorpay_active" class="form-control">
                                    <option value="0"
                                        {{ get_system_setting('razorpay_active') == false ? 'selected' : '' }}>
                                        {{ __('messages.disabled') }}</option>
                                    <option value="1"
                                        {{ get_system_setting('razorpay_active') == true ? 'selected' : '' }}>
                                        {{ __('messages.active') }}</option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group required">
                                <label for="mollie_api_key">{{ __('messages.mollie_api_key') }}</label>
                                <input name="mollie_api_key" type="text" class="form-control"
                                    placeholder="{{ __('messages.mollie_api_key') }}"
                                    value="{{ get_system_setting('mollie_api_key') }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <select name="mollie_test_mode" class="form-control">
                                    <option value="0"
                                        {{ get_system_setting('mollie_test_mode') == false ? 'selected' : '' }}>
                                        {{ __('messages.false') }}</option>
                                    <option value="1"
                                        {{ get_system_setting('mollie_test_mode') == true ? 'selected' : '' }}>
                                        {{ __('messages.true') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <select name="mollie_active" class="form-control">
                                    <option value="0"
                                        {{ get_system_setting('mollie_active') == false ? 'selected' : '' }}>
                                        {{ __('messages.disabled') }}</option>
                                    <option value="1"
                                        {{ get_system_setting('mollie_active') == true ? 'selected' : '' }}>
                                        {{ __('messages.active') }}</option>
                                </select>
                            </div>
                        </div>
