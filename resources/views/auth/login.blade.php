            ...
            <div class="card mb-0">
                <div class="card-body">
                    ...
                    <form method="POST" class="auth-login-form mt-2" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            <label for="login-email" class="form-label">{{ __('E-Mail Address') }}</label>

                                <input id="email" type="email" placeholder="Enter your email" class="form-control login-form @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
