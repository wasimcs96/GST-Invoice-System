    ...
    <div class="navbar-container d-flex content">
        <div class="bookmark-wrapper d-flex align-items-center">
            ...
            <ul class="nav navbar-nav bookmark-icons">
                <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('logout') }}" data-toggle="tooltip" data-placement="top" title="Logout"><i class="ficon" data-feather="power"></i></a></li>
                <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('home') }}" data-toggle="tooltip" data-placement="top" title="Website"><i class="ficon" data-feather="globe"></i></a></li>
        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">{{ $authUser->full_name }}</span></div><span class="avatar"><img class="round" src="{{ $authUser->avatar }}" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                </a>
