...
class LedgerCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $expense_categories = LedgerCategory::findByCompany($currentCompany->id)->paginate(15);

        return view('application.settings.ledger_category.index', [
    ...
    {
        $expense_category = new LedgerCategory();
        ...
        return view('application.settings.ledger_category.create', [
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('settings.ledger_categories', ['company_uid' => $currentCompany->uid]);
    }
    ...
    {
        $expense_category = LedgerCategory::findOrFail($request->expense_category);
 
        return view('application.settings.ledger_category.edit', [
            'expense_category' => $expense_category,
        ]);
    }
